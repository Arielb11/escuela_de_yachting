...
// Main Component
export default function Meteorologiaaero() {
  return (
    <div >
        <Header />
            <div className="w-full max-w-6xl mx-auto py-12 md:py-20 mt-36">
                <div className="grid gap-8 md:gap-12">
                  <div className="grid gap-4">
                    <h1 className="text-3xl md:text-5xl font-bold text-gray-600 body-font">Curso de Meteorologia Aeronautica (Online)</h1>
                    <p className="text-lg md:text-xl text-gray-500 ">
                    El Curso está orientado a completar la formación de Pilotos Aeronáuticos mediante el conocimiento del medio en el cual desarrollan sus actividades.
                    </p>
                  </div>
                  ...
                  <div className="grid gap-8 md:grid-cols-2 items-start">
                    <div className="grid gap-4">
                        <div className="grid gap-2">
                          ...
                          El Curso está orientado a completar la formación de Pilotos Aeronáuticos mediante el conocimiento del medio en el cual desarrollan sus actividades. La Ciencia Meteorológica y la Tecnología ha puesto a disposición del personal de vuelo una serie de herramientas cuya comprensión y aplicación redunda en la Planificación y la Seguridad del vuelo. Además, será un elemento fundamental al momento de tomar decisiones durante las operaciones aéreas. La capacitación incluye el uso de Modelos Matemáticos de Pronóstico y productos de Sensores Remotos, como imágenes de Radar y Satélites Meteorológicos. El curso combina aspectos teóricos y una práctica intensiva de diagnóstico y pronóstico.
                          </p>
                        </div>
                        <hr />
                        <div className="grid gap-2">
                          ...
                          <ul className="space-y-2 text-gray-700 ">
                              ...
                              Utilizar herramientas de Ciencia Meteorológica y Tecnología para mejorar la Planificación y Seguridad del vuelo.
                              </li>
                              <li>
                              <CheckIcon className="mr-2 inline-block h-4 w-4 text-primary" />
                              Emplear Modelos Matemáticos de Pronóstico y productos de Sensores Remotos para identificar y predecir fenómenos meteorológicos.
                              </li>
                              <li>
                              <CheckIcon className="mr-2 inline-block h-4 w-4 text-primary" />
                              ...
                              <li>
                              <CheckIcon className="mr-2 inline-block h-4 w-4 text-primary" />
                              Fomentar el intercambio de conocimientos y experiencias entre docentes y cursantes a través de la comunicación y el debate.
                              </li>
                          </ul>
                        </div>
                        <hr />
