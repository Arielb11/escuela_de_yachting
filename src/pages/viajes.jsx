        ...
        <>
            ...
            <div className="relative mt-24">
                ...
                <div className="absolute top-0 left-0 w-full h-full flex items-center justify-start">
                    <h1 className="font-Dafoe text-white text-xl sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl m-4">
            ...
            <section class="bg-white py-5">
                <div class="container px-6 py-10 mx-auto">
                    <div class="lg:-mx-6 lg:flex lg:items-center">
                        <img class="object-cover object-center lg:w-1/2 lg:mx-6 w-full h-96 rounded-lg lg:h-[36rem]" src="/src/assets/img/viajes-brasil2.jpg" alt=""/>

                        <div class="mt-8 lg:w-1/2 lg:px-6 lg:mt-0">
                            <img className="h-14 w-14" src="/src/assets/videos/balneario.gif" alt="" />

                            <h1 class="text-4xl font-semibold text-gray-800  lg:text-5xl lg:w-96">
                                BRASIL
                            </h1>
                            ...
                            <button class="flex items-center px-4 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-green-600 rounded-lg hover:bg-green-500 focus:outline-none focus:ring focus:ring-green-300 focus:ring-opacity-80">
                                ...
                                <span class="mx-2">Contactanos</span>
                            </button>
                            </div>
                        </div>
                    </div>
            ...
            <section class="bg-white py-5">
                <div class="container px-6 py-10 mx-auto">
                    <div class="lg:-mx-6 lg:flex lg:items-center">
                        <img class="object-cover object-center lg:w-1/2 lg:mx-6 w-full h-96 rounded-lg lg:h-[36rem]" src="/src/assets/img/uruguay.jpg" alt=""/>
